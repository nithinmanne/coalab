...
findDet:
	...
	la $a0, rin 		#$a0 -> address of 'rin'
 	...
 	b findDetreturn
 	findDetNotBase2:
 	li $t2, 1		#for alternating addition and subtraction
 	...
 	findDetloop:
 		...
 		mul $t3, $t3, $v1		#$t3 = value * sub-determinant
 		mul $t3, $t3, $t2		#plus or minus
...
makeArr:
	...
	jal malloc 			#malloc for new array
	move $sp, $t1		#Recover $sp
	move $t1, $v0		#$t1 = address of new array
	move $v1, $v0		#$v1 = address of new array
	move $v0, $t0		#$v0 = n-1
	move $t0, $t3		#$t0 = n
	move $a0, $t3
	add $t0, $t0, $t0
